...
public class Inky {
	...
	public Inky(Color _bodyColor, Color _eyeColor, Color _pupilColor){
	...
	public void move(Pacman pacman){
		if(Coordinator.levelCount==0) smartCount = 50;
		if(Coordinator.levelCount==1) smartCount = 25;
	...
	public void draw(DrawingBoard board){
		...
		if(Pacman.ghostDanger && pacman.isToEatInky==false){
	...
	public void movingRight() {
		...
		//System.out.println("This is x and y right as entring thr right mrthod: " + x + " " + y);
		
		if(x==pacman.x && y!=pacman.y && x % 20 == 0 && y % 20 == 0 && pacman.ghostDanger==false){
			movingRight = false;
			canSkip = false;
			canMove = true;
			//System.out.println("This is x and y right as entring thr check block: " + x + " " + y);
			return;
			
		}
		//System.out.println("This is x and y right as leaving thr check block: " + x + " " + y);
if(realY>800) return;
