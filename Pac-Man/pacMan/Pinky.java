...
public class Pinky {
	...
	public int pinkyfirstMovement = 0;
	public int pinkysecondMovement = 0;
	...
	public Pinky(Color _bodyColor, Color _eyeColor, Color _pupilColor){
	...
	public void move(Pacman pacman){
		...
		if(pinkyfirstMovement<10){
			x = x - 2;
			pinkyfirstMovement++;
			return;
		}
		
		if(pinkysecondMovement<10){
			y = y - 2;
			pinkysecondMovement++;
			return;
		}
	...
	public void draw(DrawingBoard board){
		...
		if(Pacman.ghostDanger && pacman.isToEatPinky==false){
