...
public class Blinky {
	...
	public boolean canMoveRandom = true;
	...
	public Blinky(Color _bodyColor, Color _eyeColor, Color _pupilColor){
	...
	public void draw(DrawingBoard board){
		...
		if(Pacman.ghostDanger && pacman.isToEatBlinky==false){
